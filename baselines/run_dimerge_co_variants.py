...
# NMTFcoclust, nonnegfac-python, coclust_shim live in big-cocluster-paper/baselines
DEPS_DIR = Path(os.environ.get("DIMERGE_DEPS_DIR",
                                "/home/jie/big-cocluster-paper/baselines"))
DATA_DIR = Path("/home/jie/fast_cocluster/data")
...
def _setup_nmtfcoclust_imports():
    ...
    nmtfcoclust_dir = DEPS_DIR / "NMTFcoclust"
...
def atom_fnmf(X_sub, k, seed=0):
    ...
    nonnegfac_dir = DEPS_DIR / "nonnegfac-python"
